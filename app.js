...
/* ─── FLAGS MAP ───────────────────────────────────────────── */
const FLAGS = {argentina: "ar",  brazil: "br",  mexico: "mx",  spain: "es",  france: "fr",  germany: "de",  portugal: "pt",  england: "gb-eng",  morocco: "ma",  japan: "jp",  uruguay: "uy",
    colombia: "co",  netherlands: "nl",  croatia: "hr",  senegal: "sn",  ecuador: "ec",  "united states": "us",  usa: "us",  canada: "ca",  australia: "au",  switzerland: "ch",  belgium: "be",  italy: "it",
      ghana: "gh",  serbia: "rs",  tunisia: "tn",  "costa rica": "cr",  cameroon: "cm",  wales: "gb-wls",  "saudi arabia": "sa",  qatar: "qa",  poland: "pl",  denmark: "dk",  "south korea": "kr",
        korea: "kr",  iran: "ir",  nigeria: "ng",  chile: "cl",  peru: "pe",  paraguay: "py",  bolivia: "bo",  honduras: "hn",  panama: "pa",  jamaica: "jm",  "new zealand": "nz",
          "south africa": "za",  algeria: "dz",  egypt: "eg",  greece: "gr",  turkey: "tr",  ukraine: "ua",  sweden: "se",  norway: "no",  scotland: "gb-sct",  austria: "at",  "czech republic": "cz",
          "bosnia and herzegovina": "ba",  "curaçao": "cw",  "cape verde": "cv",  "ivory coast": "ci",  "dr congo": "cd",  "uzbekistan": "uz",  "iraq": "iq",  "jordan": "jo",  "haiti": "ht"
}
